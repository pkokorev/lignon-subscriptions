...
import ch.iterial.lignon.subscriptions.config.audit.AuditEventConverter;
import ch.iterial.lignon.subscriptions.domain.PersistentAuditEvent;
...
import static ch.iterial.lignon.subscriptions.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
