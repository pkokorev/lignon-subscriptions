...
import ch.iterial.lignon.subscriptions.config.Constants;
import ch.iterial.lignon.subscriptions.LignonSubscriptionsApp;
import ch.iterial.lignon.subscriptions.domain.Authority;
import ch.iterial.lignon.subscriptions.domain.User;
import ch.iterial.lignon.subscriptions.repository.AuthorityRepository;
import ch.iterial.lignon.subscriptions.repository.UserRepository;
import ch.iterial.lignon.subscriptions.security.AuthoritiesConstants;
import ch.iterial.lignon.subscriptions.service.MailService;
import ch.iterial.lignon.subscriptions.service.dto.UserDTO;
import ch.iterial.lignon.subscriptions.service.dto.PasswordChangeDTO;
import ch.iterial.lignon.subscriptions.web.rest.errors.ExceptionTranslator;
import ch.iterial.lignon.subscriptions.web.rest.vm.KeyAndPasswordVM;
import ch.iterial.lignon.subscriptions.web.rest.vm.ManagedUserVM;
import ch.iterial.lignon.subscriptions.service.UserService;
...
@SpringBootTest(classes = LignonSubscriptionsApp.class)
